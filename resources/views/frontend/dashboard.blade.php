                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="card-item">
                            <div class="card-bg-color">
                                <img src="{{ asset('public/frontend/assets/image/icon/our-latest-img.svg') }}"
                                    alt="">
                    ...
                    <div class="col-md-4 col-sm-6 fadeup-animation-card onview-port">
                        <div class="card-item card-item-one">
                            <div class="card-bg-color">
                                <img src="{{ asset('public/frontend/assets/image/icon/our-latest-1-img.svg') }}"
                                    alt="">
                                <div class="card-bg-raund">
                                    <span>02</span>
                                </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card-item card-item-two">
                            <div class="card-bg-color">
                                <img src="{{ asset('public/frontend/assets/image/icon/our-latest-2-img.svg') }}"
                                    alt="">
                                <div class="card-bg-raund">
                                    <span>03</span>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="why-card-mb">
                            <div class="why-choose-card">
                                <img width="60px" height="60px"
                                    src="{{ asset('public/frontend/assets/image/icon/choose-svg-1.svg') }}"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="why-card-mb">
                            <div class="why-choose-card">
                                <img width="60px" height="60px"
                                    src="{{ asset('public/frontend/assets/image/icon/choose-svg-2.svg') }}"
                                    alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="why-card-mb">
                            <div class="why-choose-card">
                                <img width="60px" height="60px"
                                    src="{{ asset('public/frontend/assets/image/icon/choose-svg-3.svg') }}"
                                    alt="">
                                <h5>24*7 Support</h5>
                                <p>Ut ut eros risus. In luctus fringilla augue, eget ultricies purus. Sed mauris a nisl.
                                </p>
