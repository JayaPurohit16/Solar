                ...
                <div class="col-lg-6">
                    <div class="bg-img introduction-bg">
                        ...
                        <div class="right-img introduction-img">
                            <img src="{{ asset('frontend/assets/image/slider-4-img.jpg') }}" alt="About Two">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about-text story-text">
                        <span><img src="{{ asset('frontend/assets/image/sub-heading-img.svg') }}" alt="Sub-icon">Our
                            Story</span>
                ...
                <div class="col-md-6">
                    <div class="bg-img story-bg">
                        <div class="story-bg-img">
                            <img src="{{ asset('frontend/assets/image/slider-img.jpg') }}" alt="About One">
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="our-vision-flex">
                        <img class="our-vision-img" src="{{ asset('frontend/assets/image/have-questions-img.jpg') }}"
                            alt="">
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <section class="why-choose-sec">
        <div class="container">
            <div class="why-choose-sec-text">
                <span><img src="{{ asset('frontend/assets/image/sub-heading-img.svg') }}" alt="">Mission</span>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="objective-sec-img">
                        <img src="{{ asset('frontend/assets/image/articl-1-img.jpg') }}" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
