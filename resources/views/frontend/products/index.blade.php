                ...
                <div class="news-right-sec">
                    <div class="news-right-text">
                        @if (isset($product->image) && file_exists(public_path('Services/Image/' . $product->image)))
                            <img class="product-section-img" src="{{ asset('public/Services/Image/' . $product->image) }}"
                                alt="Image">
                        @else
                            ...
                            <div class="video-men" style="position: relative;">
                                <div class="video-bgimg">
                                    ...
                                    <button type="button" class="btn video-btn" data-bs-toggle="modal"
                                        ...
                                        <img src="{{ asset('public/frontend/assets/image/icon/video-svg.svg') }}"
                                            alt="Video Svg">
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="why-choose-sec-card">
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 p-sm-1 p-0">
                                    <div class="why-choose-card news-right-card">
                                        <img src="{{ asset('public/frontend/assets/image/icon/news-right-svg.svg') }}"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-sm-6 p-sm-1 p-0">
                                    <div class="why-choose-card news-right-card">
                                        <img src="{{ asset('public/frontend/assets/image/icon/news-card1-svg.svg') }}"
                                            alt="">
                                        <h5>Energy Saving</h5>
                                        <p>Ut ut eros risus. In luctus fringilla augue, eget ultricies purus. Sed
                                            mauris
                                ...
                                <div class="col-lg-4 col-sm-6 p-sm-1 p-0">
                                    <div class="why-choose-card news-right-card">
                                        <img src="{{ asset('public/frontend/assets/image/icon/choose-svg-2.svg') }}"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-sm-6 p-sm-1 p-0">
                                    <div class="why-choose-card news-right-card">
                                        <img src="{{ asset('public/frontend/assets/image/icon/choose-svg-3.svg') }}"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-sm-6 p-sm-1 p-0">
                                    <div class="why-choose-card news-right-card">
                                        <img src="{{ asset('public/frontend/assets/image/icon/news-card2-svg.svg') }}"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-sm-6 p-sm-1 p-0">
                                    <div class="why-choose-card news-right-card">
                                        <img src="{{ asset('public/frontend/assets/image/icon/news-card3-svg.svg') }}"
                                            alt="">
            ...
            <div class="modal-body">
                @if (isset($product->why_us_video_link) && $product->why_us_video_link != null)
                                ...
                                @if ($product->why_us_video_link)
                                    <iframe width="315" height="400" src="https://www.youtube.com/embed/{{ $product->why_us_video_link }}"
